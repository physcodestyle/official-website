...
При разработке сайта применяется технология Mobile-first. Сначала создается мобильная версия блока, а потом начинаем увеличивать с помощью @media. Нет брекпоинтов для адаптации. Каждый блок сам определяет для себя, когда ему пора меняться.
