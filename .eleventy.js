    ...
    switch (language) {
      case 'en':
        ...
        lang += `<a class="languages__flag button button--sticky" href="${url}">
          <img class="languages__flag-icon button__icon" src="/assets/Icon/Flag/RU/Large.svg" width="24" height="24" title="На русском языке" />
        </a>`;
        break;
      case 'ru':
        if (url.includes('ru')) {
        ...
        lang += `<a class="languages__flag button button--sticky" href="${url}">
          <img class="languages__flag-icon button__icon" src="/assets/Icon/Flag/GB/Large.svg" width="24" height="24" title="In English" />
        </a>`;
        break;
    }
    lang += `</div>`;
